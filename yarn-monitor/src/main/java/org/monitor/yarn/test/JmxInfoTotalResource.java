 ...
 */
public class JmxInfoTotalResource {
    ...
    private String FairShareMB;
    private String FairShareVCores;
    private String SteadyFairShareMB;
    private String SteadyFairShareVCores;
    private String MinShareMB;
    private String MinShareVCores;
    private String MaxShareMB;
    private String MaxShareVCores;
    ...
    public String getFairShareMB() {
        return FairShareMB;
    }

    public void setFairShareMB(String fairShareMB) {
        FairShareMB = fairShareMB;
    }

    public String getFairShareVCores() {
        return FairShareVCores;
    }

    public void setFairShareVCores(String fairShareVCores) {
        FairShareVCores = fairShareVCores;
    }

    public String getSteadyFairShareMB() {
        return SteadyFairShareMB;
    }

    public void setSteadyFairShareMB(String steadyFairShareMB) {
        SteadyFairShareMB = steadyFairShareMB;
    }

    public String getSteadyFairShareVCores() {
        return SteadyFairShareVCores;
    }

    public void setSteadyFairShareVCores(String steadyFairShareVCores) {
        SteadyFairShareVCores = steadyFairShareVCores;
    }

    public String getMinShareMB() {
        return MinShareMB;
    }

    public void setMinShareMB(String minShareMB) {
        MinShareMB = minShareMB;
    }

    public String getMinShareVCores() {
        return MinShareVCores;
    }

    public void setMinShareVCores(String minShareVCores) {
        MinShareVCores = minShareVCores;
    }

    public String getMaxShareMB() {
        return MaxShareMB;
    }

    public void setMaxShareMB(String maxShareMB) {
        MaxShareMB = maxShareMB;
    }

    public String getMaxShareVCores() {
        return MaxShareVCores;
    }

    public void setMaxShareVCores(String maxShareVCores) {
