...
public class JDBCHelper {
    static {
    try {
        String driver = PropertyFetcher.getProperty(Constants.JDBC_DRIVER);
    ...
    private JDBCHelper() {
        ...
        int datasourceSize = PropertyFetcher.getInt(
        ...
        for(int i = 0; i < datasourceSize; i++) {
            ...
            String password = null;
                ...
                url = PropertyFetcher.getProperty(Constants.JDBC_URL);
                user = PropertyFetcher.getProperty(Constants.JDBC_USER);
                password = PropertyFetcher.getProperty(Constants.JDBC_PASSWORD);
